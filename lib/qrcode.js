...
QRCode.prototype.svg = function(opt) {
    ...
    var defs = predefined ? indent + '<defs><path id="qrmodule" d="M0 0 h' + ysize + ' v' + xsize + ' H0 z" style="shape-rendering:crispEdges;" /></defs>' + EOL : '';
        ...
        for (var x = 0; x < length; x++) {
            ...
            if (module) {
                ...
                if (join) {
                    ...
                    modrect += indent + '<rect x="' + px.toString() + '" y="' + py.toString() + '" width="' + xsize + '" height="' + ysize + '" style="shape-rendering:crispEdges;"/>' + EOL;
                }
            }
        }
    }
    ...
    if (join) {
        modrect = indent + '<path x="0" y="0" style="shape-rendering:crispEdges;" d="' + pathdata + '" />';
    }
